...
namespace RTDK.Editor
{
    public class PivotChanger : EditorWindow
    {
        ...
        [MenuItem("RTDK/Tools/Change Pivot")]
        private static void Init()
        {
            PivotChanger window = GetWindow<PivotChanger>();
        ...
        private void OnGUI()
        {
            ...
            GUILayout.Box("PIVOT CHANGER", headerStyle, GUILayout.ExpandWidth(true), headerHeight);
